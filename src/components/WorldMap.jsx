...
export default function WorldMap({handleNext, mapType}) {
    ...
    return (
        <div className="world-map" onMouseMove={handleMouseMove}>
            ...
            {mapType=== 'world' && <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 607.77 442.9" className="map-color"><g id="america" onMouseEnter={(e) => handleMouseEnter(e, 'Información de América')} onMouseLeave={handleMouseLeave} onClick={()=>handleCountryInfo('America')}>
            ...
            <g id="europa" onMouseEnter={(e) => handleMouseEnter(e, 'Información de Europa')} onMouseLeave={handleMouseLeave} onClick={()=>handleCountryInfo('Europa')}>
            ...
            <g id="africa" onMouseEnter={(e) => handleMouseEnter(e, 'Información de África')} onMouseLeave={handleMouseLeave} onClick={()=>handleCountryInfo('Africa')}>
            ...
            <g id="asia" onMouseEnter={(e) => handleMouseEnter(e, 'Información de Asia')} onMouseLeave={handleMouseLeave} onClick={()=>handleCountryInfo('Asia')}>
            ...
            <g id="oceania" onMouseEnter={(e) => handleMouseEnter(e, 'Información de Oceanía')} onMouseLeave={handleMouseLeave} onClick={()=>handleCountryInfo('Oceania')}>
